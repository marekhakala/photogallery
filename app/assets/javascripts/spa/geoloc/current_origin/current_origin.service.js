(function() {
  ...
  angular.module("spa.geoloc")
    .service("spa.geoloc.currentOrigin", CurrentOrigin);
  ...
  CurrentOrigin.prototype.getPosition = function() {
    return this.location && this.location.position ? angular.copy(this.location.position) : null;
  }

  CurrentOrigin.prototype.getAddress = function() {
    return this.location && this.location.address ? angular.copy(this.location.address) : null;
  }
