class GeocoderCache
  ...
  def geocode address
    ...
    unless cache
      ...
      if geoloc
        ...
        lat: geoloc.position.lat, address: address, location: geoloc.to_hash)
      end
    end
  ...
  def reverse_geocode point
    ...
    unless cache
      ...
      if geoloc
        cache = CachedLocation.create(lng: point.lng, lat: point.lat,
          address: geoloc.formatted_address, location: geoloc.to_hash)
      end
    end
